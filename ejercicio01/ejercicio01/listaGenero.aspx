<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="listaGenero.aspx.cs" Inherits="ejercicio01.listaGenero" %>
...
<body>
    ...
    <div>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="getAll" TypeName="BackEnd.DAOS.GeneroDao"></asp:ObjectDataSource>
