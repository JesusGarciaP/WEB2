<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="listaGenerosGrupos.aspx.cs" Inherits="ejercicio01.listaGenerosGrupos" %>
...
<body>
    ...
    <div>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="getAll" TypeName="BackEnd.DAOS.GenerosGruposDao"></asp:ObjectDataSource>
